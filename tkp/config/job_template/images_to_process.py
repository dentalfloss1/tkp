...
# 
# pimsfiles = glob.glob("/home/example/data/*.pims")
# images = []
# cwd = os.getcwd()
# allfreq = []
...
#         images.append((file,i,pbpath))
#         allfreq = allfreq.append((pbpath,header,data.shape[-1]))
#         # add portion to compute primary beam corrections
# allfreq = np.array(affreq,dtype=[('file','<U256'),('header','O'),('imSize','i8')])
# uniquefreqs = np.unique(allfreq['file'],return_index=True)
